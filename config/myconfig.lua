...
-- ------------------------------------------------------------------------
config.use_terms = "==== Nutzungsbedingungen für die LiquidFeedback-Plattform der Piratenpartei Österreichs ==== \
=== Inhaltsverzeichnis === \
# Geltungsbereich \
# LiquidFeedback \
# Registrierung für LiquidFeedback \
# Zugangsdaten \
# Inhalte der Mitglieder und Nutzungsrechte \
# Generelle Regeln für die Nutzung von LiquidFeedback \
...
=== §1. Geltungsbereich === \
 \
(1) Die nachfolgenden Nutzungsbedingungen in der jeweils letzten Fassung gelten für die Nutzung der LiquidFeedback-Plattform (im Folgenden als „LiquidFeedback“ bezeichnet) der Piratenpartei Österreichs (im Folgenden als die „Piratenpartei“ oder „wir“ bezeichnet) durch Mitglieder und Dritte (im Folgenden auch als die „Teilnehmer“ oder „du“/„ihr“/„euch“ bezeichnet) und alle von uns in diesem Verhältnis angebotenen und erbrachten Leistungen. \
 \
(2) Unsere Nutzungsbedingungen gelten auch für die Nutzung von LiquidFeedback über mobile Endgeräte. \
 \
=== §2. LiquidFeedback === \
 \
(1) LiquidFeedback ist ein Angebot der Piratenpartei an alle Parteimitglieder, sich im Internet unmittelbar am Meinungsbildungs- und Beschlussprozess innerhalb der Piratenpartei zu beteiligen. Die Teilnehmer können Anträge einbringen, Initiativen beginnen und bereits existierende Anträge und Initiativen unterstützen oder ablehnen, Anregungen geben und vieles mehr. Über die Anträge und Initiativen können die Teilnehmer online abstimmen. Dabei ist es möglich, die eigene Stimme global, themenbereichs- oder themenbezogen zu übertragen (in LiquidFeedback „delegieren“ genannt). \
 \
(2) Die Details zu den Nutzungsmöglichkeiten auf LiquidFeedback werden euch auf der Website im Zusammenhang mit den jeweiligen Funktionen erläutert. Jeder Teilnehmer erklärt sich damit einverstanden, die jeweils gültigen Funktionsweisen von LiquidFeedback in eigener Verantwortung und auf eigene Gefahr zu überprüfen und anzuwenden. \
 \
(3) Die aktuelle Satzungs- und Geschäftsordnungslage der Piratenpartei Österreichs gilt vorrangig und bestimmt die innerparteiliche Behandlung jeglicher LiquidFeedback-Anträge und -Resultate. Nur vorsorglich weisen wir darauf hin, dass Initiativen und Anträge, die die mehrheitliche Zustimmung der abstimmenden Teilnehmer gefunden haben, grundsätzlich keinen Anspruch auf Annahme und Umsetzung durch die Piratenpartei haben. Sieht die Satzung und die Geschäftsordnung eine direkte Umsetzung von LiquidFeedback-Beschlüssen vor, so trifft dies nur auf Anträge mit Regelwerken zu, in denen eine direkte Umsetzung vorgesehen ist, und nur, sofern diese in keinem unpassenden Themenbereich eingereicht wurden und jegliche in Satzung und Geschäftsordnung festgelegten weiteren Anforderungen an den Antrag und die Abstimmung erfüllt werden. Die Nutzung von LiquidFeedback ist selbstverständlich nicht Voraussetzung für die Ausübung der Rechte als Parteimitglied. \
 \
=== §3. Registrierung für LiquidFeedback === \
 \
(1) Um Teilnehmer bei LiquidFeedback zu werden, musst du Mitglied der Piratenpartei sein und dich auf der Plattform registrieren. \
 \
...
(3) Die im Zuge der Registrierung erfragte E-Mail-Adresse muss erreichbar sein und dir gehören. Wir schicken dir zum Zwecke der Verifizierung der E-Mail-Adresse eine Bestätigungs-E-Mail, die einen von dir anzuwählenden Bestätigungslink und hilfsweise einen Link zu einer gesonderten Website zusammen mit einem dort einzugebenden Code enthält. Du bist verpflichtet, uns jede Änderung der von dir für die Verwendung innerhalb von LiquidFeedback bestimmten E-Mail-Adresse anzuzeigen. \
 \
(4) Wenn du den Registrierungsprozess einschließlich der Verifizierung deiner Person als stimmberechtigtes Parteimitglied (Akkreditierung – siehe hierzu mehr in §2 der Datenschutzerklärung) durchlaufen hast und deine Zustimmung zu diesen Nutzungsbedingungen, der Datenschutzerklärung und den Lizenzbedingungen für die dir eingestellten Inhalte (siehe hierzu unten unter §5) erklärt hast, gibst du durch das Klicken des Buttons „Registrieren“ ein Angebot auf Abschluss einer vertraglichen Vereinbarung zwischen dir und der Piratenpartei über die Nutzung von LiquidFeedback ab (im Folgenden „Nutzungsvereinbarung“ genannt). Dieses Angebot nehmen wir durch die Weiterleitung auf die LiquidFeedback-Startseite an. \
 \
(5) Wir behalten uns vor, die erneute Registrierung eines einmal aus LiquidFeedback ausgeschlossenen Parteimitglieds genau zu prüfen und gegebenenfalls auch zu verweigern. \
 \
(6) Die Piratenpartei Österreichs behält sich die jederzeitige, unter größtmöglicher Wahrung individueller Rechte zu handhabende, temporäre oder permanente Sperrung eines Teilenehmers im Fall von Verstößen gegen die Nutzungsbedingungen oder damit verbundener Erklärungen/Verträgen sowie jegliche Maßnahmen nach §9 vor. \
 \
=== §4. Zugangsdaten === \
 \
(1) Deine Zugangsdaten (Anmeldenamen und das von dir gewählte Passwort) sind ausschließlich für die Nutzung durch dich persönlich bestimmt. Du darfst die Zugangsdaten an niemand anderen weitergeben, auch nicht an andere Parteimitglieder. Du bist verpflichtet, die Zugangsdaten geheim zu halten und die unberechtigte Nutzung von LiquidFeedback durch Dritte auf diesem Weg zu verhindern. \
 \
Teilnehmer, die aus in ihrer Person liegenden Gründen LiquidFeedback nicht uneingeschränkt nutzen können und dafür die Hilfe Dritter benötigen, können Ausnahmen bei der BGF der Piratenpartei Österreichs beantragen. \
 \
...
Der Betrieb einer Internet-Plattform wie LiquidFeedback bedingt es, dass wir einige Nutzungsrechte von unseren Teilnehmern tatsächlich eingeräumt erhalten. Vor diesem Hintergrund gilt: \
 \
(1) Wenn du Anträge, Initiativen, Kommentare, Bewertungen, Stimmabgaben und sonstige Beiträge in LiquidFeedback einstellst (im Folgenden „Inhalte“ genannt“), räumst du uns an diesen Inhalten jeweils unwiderrufliche, räumlich und zeitlich unbeschränkte Nutzungsrechte in dem zum Betrieb von LiquidFeedback erforderlichen Umfang ein. Insbesondere räumst du uns das Recht ein, die betreffenden Inhalte im Rahmen der Plattform technisch zum Abruf bereitzustellen und die hierfür erforderlichen Vervielfältigungen vorzunehmen (Speichern auf unseren Servern etc.). Darüber hinaus räumst du uns insbesondere das Recht ein, die Inhalte im Rahmen unserer Funktion als Betreiber von LiquidFeedback sowie als politische Partei öffentlich zugänglich zu machen, zu senden und anderweitig öffentlich wiederzugeben. In diesem Zusammenhang weisen wir auf die folgenden technischen Besonderheiten hin: \
 \
LiquidFeedback verändert sich und erweitert ggf. auch seine Funktionen mit dem Stand der Technik. Daher kann es für die Teilnehmer bestimmte Zusatzfunktionen wie Newsfeeds (ggf. in verschiedenen Formaten) und andere Abonnement-Dienste (Push-Dienste) oder Abruf-Dienste (Pull-Dienste) geben. Auch technisch optimierte Versionen von LiquidFeedback für die Nutzung auf mobilen Endgeräten bzw. entsprechende Apps können angeboten werden, ebenso E-Mail-Newsletter. Die uns gemäß dieses §5.1 (1) eingeräumten nicht-ausschließlichen Rechte erstrecken sich auch auf solche Zusatzfunktionen. Die eingeräumten Rechte sind dabei aber stets auf die Funktionen und Nutzungsmöglichkeiten von LiquidFeedback oder unserer parteipolitischen Betätigung beschränkt und dienen auf keinen Fall der wirtschaftlichen Vermarktung deiner Inhalte (zu Wahlkämpfen siehe §5.2 (2)). \
 \
...
(2) Weiters räumst du uns das unwiderrufliche, räumlich und zeitlich unbeschränkte Recht ein, deine Inhalte (ausgenommen natürlich die Profilinhalte (zu diesen siehe §2.3 der Datenschutzerklärung)) für sonstige statistische Zwecke zu nutzen und/oder durch Dritte nutzen zu lassen. \
 \
(3) Ferner räumst du uns das unwiderrufliche, räumlich und zeitlich unbeschränkte Recht ein, von dir verfasste Initiativtexte oder andere Texte auf LiquidFeedback im Rahmen von Wahlkämpfen oder der allgemeinen Parteiwerbung der Piratenpartei zu nutzen, zum Beispiel indem wir den Text – auch in verkürzter oder zusammengefasster Form – in einen Flyer oder ein Wahlplakat aufnehmen oder auf unserer Website nutzen. Vor der Verwendung deines Teilnehmernamens werden wir dich jedoch um Zustimmung bitten. \
 \
== §5.3 Nutzungsrechte an den Inhalten der Nutzer für Teilnehmer und Dritte == \
 \
(1) Alle Initiativen, Anträge und sonstigen Beiträge, die auf LiquidFeedback eingestellt werden, werden, soweit sie schutzfähig sind, unter der Creative Commons Attribution-Share Alike 3.0 Austria-Lizenz veröffentlicht. Durch Klicken der entsprechenden Checkbox im Zuge deiner Registrierung willigst du in die Veröffentlichung auch deiner Initiativen, Anträge und sonstigen Beiträge unter der genannten Lizenz ein. Zudem stimmst du einer Autoren-Nennung mindestens durch URL oder Verweis auf den Beitrag zu. \
 \
...
=== §7. Gewährleistung und Haftung des Teilnehmers / Freistellung mit Blick auf rechtswidrige Inhalte === \
 \
(1) Du gewährleistest uns gegenüber, dass du zur Einräumung der Rechte in dem durch §5 bestimmten Umfang berechtigt und in der Lage bist. Du gewährleistest uns gegenüber ebenso, keine Inhalte in LiquidFeedback einzustellen, deren Gegenstand oder Inhalt gegen die Regelungen der §6 verstoßen, sowie auch keine der dort verbotenen Handlungen zu begehen oder dort bezeichnete Einschränkungen zu übertreten sowie keine unzutreffenden Daten anzugeben, wenn du dich für die Angabe von Daten entscheidest. \
 \
(2) Du bist für sämtliche von dir in LiquidFeedback eingestellten Inhalte, insbesondere die Texte, und für das Vorhandensein der hierfür etwaig erforderlichen Rechtspositionen ebenso allein verantwortlich wie für deine Handlungen in LiquidFeedback. Wir prüfen deine Inhalte und Handlungen grundsätzlich nicht. \
 \
...
(2) Wir behalten uns vor, den Teilnehmer-Account bis zur Zahlung zu sperren, wenn ein registrierter Teilnehmer mit einem fälligen Mitgliederbeitrag in Verzug ist. \
 \
(3) Ebenso behalten wir es uns vor, den Teilnehmer-Account zeitweilig oder dauerhaft zu sperren, wenn dem Teilnehmer, aus welchen Gründen auch immer, zeitweilig oder dauerhaft sein ordentliches Stimmrecht als Mitglied der Piratenpartei entzogen wurde. \
 \
=== §10. Beendigung der Nutzungsvereinbarung === \
 \
(1) Die Nutzungsvereinbarung endet automatisch, wenn die Parteimitgliedschaft des Teilnehmers endet. \
 \
(2) Die Nutzungsvereinbarung kann von dir zudem jederzeit ordentlich binnen 14 Tagen gekündigt werden. Eine fristlose außerordentliche Kündigung aus wichtigem Grund ist beiden Parteien vorbehalten. Jede Kündigung bedarf der Textform, das heißt mindestens einer E-Mail. \
 \
(3) Wie wir nach Beendigung der Nutzungsvereinbarung mit deinen Inhalten verfahren, ist in §4.3 der Datenschutzerklärung im Einzelnen erläutert. \
 \
(4) Eine Reaktivierung eines Teilnehmer-Accounts nach Kündigung ist grundsätzlich nicht möglich. \
 \
=== §11. Datenschutz === \
 \
...
config.use_terms_checkboxes = {
  ...
  },
  {
    ...
    html = "Ich akzeptiere die <a href=\"" .. config.absolute_base_url .. "static/privacy.php\">Datenschutzerklärung</a>.",
    not_accepted_error = "Um dich zu registrieren, musst du die <a href=\"" .. config.absolute_base_url .. "static/privacy.php\">Datenschutzerklärung</a> akzeptieren."
  }
}
...
-- ------------------------------------------------------------------------
config.instance_name = "Piratenpartei Österreichs"
...
config.mail_from = { name = "LiquidFeedback", address = "lqfbsupport@piratenpartei.at" }
...
-- ------------------------------------------------------------------------
config.motd_public = '===Disclaimer===\nTexte und Anträge in LiquidFeedback stellen bis zur [https://wiki.piratenpartei.at/wiki/Taskforce:LiquidFeedback/Beschlussregister erfolgreichen Abstimmung in direkten Regelwerken] keine offizielle Parteimeinung dar.'
