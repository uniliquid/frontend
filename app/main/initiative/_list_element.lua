          ...
          if initiative.positive_direct_votes and initiative.negative_direct_votes then
            ui.bargraph{
              ...
              bars = {
                ...
                { color = "#aaa", value = initiative.issue.direct_voter_count - initiative.direct_negative_votes - initiative.direct_positive_votes, text = _"Abstention" },
                { color = "#ddd", value = max_value - initiative.negative_votes - initiative.positive_votes - (initiative.issue.direct_voter_count - initiative.direct_negative_votes - initiative.direct_positive_votes), text = _"Abstention (delegation)" },
