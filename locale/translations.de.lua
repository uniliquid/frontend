...
["Please choose a login name. This name will not be shown to others and is used only by you to login into the system. The login name is case sensitive."] = "Bitte wähle einen Login. Dieser wird anderen nicht gezeigt und nur von dir zum Login verwendet. Groß- und Kleinschreibung wird berücksichtigt.";
["Please choose a login name. This name will not be shown to others and is used only by you to login into the system. The login name is case sensitive."] = "Bitte wähle einen Login. Dieser wird anderen nicht gezeigt und nur von Dir zum Login verwendet. Groß- und Kleinschreibung wird berücksichtigt.";
